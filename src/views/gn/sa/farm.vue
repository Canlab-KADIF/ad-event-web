...
<script>
import { GetSaFarm } from '@/api/index';
	...
	methods: {
		initData() {
			...
			downloadExcel(){
				...
				XLSX.utils.book_append_sheet(workBook, excelData, '균종별공급농가현황');  // 시트 명명, 데이터 지정
				XLSX.writeFile(workBook, this.searchSDT.replace('-','')+'_균종별공급농가현황.xlsx'); // 엑셀파일 만듬
